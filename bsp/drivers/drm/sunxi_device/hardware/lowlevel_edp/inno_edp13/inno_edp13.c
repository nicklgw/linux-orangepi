...
bool edp_hal_support_enhance_frame(struct sunxi_edp_hw_desc *edp_hw)
{
	return true;
}

s32 edp_hal_enhance_frame_enable(struct sunxi_edp_hw_desc *edp_hw, bool enable)
{
	u32 reg_val;
...
static struct sunxi_edp_hw_video_ops inno_edp13_video_ops = {
	...
	.enhance_frame_enable = edp_hal_enhance_frame_enable,
	.support_enhance_frame = edp_hal_support_enhance_frame,
};
